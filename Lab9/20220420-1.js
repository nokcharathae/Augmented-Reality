  ...
  if (results.multiFaceLandmarks) {
    for (const landmarks of results.multiFaceLandmarks) {
      ...
      if(oval_point_mesh==null){
        ...
        const poin_mat=new THREE.PointsMaterial({color:0xFF0000,size:0.05});
        ...
        oval_line=new THREE.Line(oval_line_geometry,new THREE.LineBasicMaterial({color:0xFF0000}));
      ...
      // typescript를 쓰는 이유
      // array = new Float32Array(num_oval_points)
